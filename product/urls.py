...
urlpatterns = [
    ...
    # /products/?search=laptop              ← Search by product name/description
    # /products/?category=Electronics       ← Filter by category (custom filter)
    # /products/?min_price=1000&max_price=5000  ← Filter by price range (custom)
    # /products/?page=2
